...
// GetDepositMode returns the DepositMode field value if set, zero value otherwise.
func (o *QuoteRequest) GetDepositMode() string {
	if o == nil || IsNil(o.DepositMode) {
		var ret string
		return ret
	}
	return *o.DepositMode
}

// GetDepositModeOk returns a tuple with the DepositMode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QuoteRequest) GetDepositModeOk() (*string, bool) {
	if o == nil || IsNil(o.DepositMode) {
		return nil, false
	}
	return o.DepositMode, true
}
...
// SetDepositMode gets a reference to the given string and assigns it to the DepositMode field.
...
func (o *QuoteRequest) GetVirtualChainRecipient() string {
	...
	return *o.VirtualChainRecipient
}

// GetVirtualChainRecipientOk returns a tuple with the VirtualChainRecipient field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QuoteRequest) GetVirtualChainRecipientOk() (*string, bool) {
	if o == nil || IsNil(o.VirtualChainRecipient) {
		return nil, false
	}
	return o.VirtualChainRecipient, true
}
...
func (o *QuoteRequest) GetVirtualChainRefundRecipient() string {
	if o == nil || IsNil(o.VirtualChainRefundRecipient) {
		var ret string
		return ret
	}
	return *o.VirtualChainRefundRecipient
}

// GetVirtualChainRefundRecipientOk returns a tuple with the VirtualChainRefundRecipient field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QuoteRequest) GetVirtualChainRefundRecipientOk() (*string, bool) {
	if o == nil || IsNil(o.VirtualChainRefundRecipient) {
		return nil, false
	}
	return o.VirtualChainRefundRecipient, true
}
...
func (o QuoteRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DepositMode) {
		toSerialize["depositMode"] = o.DepositMode
	}
