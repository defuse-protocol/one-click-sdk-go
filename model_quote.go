...
// GetDepositMemo returns the DepositMemo field value if set, zero value otherwise.
func (o *Quote) GetDepositMemo() string {
	if o == nil || IsNil(o.DepositMemo) {
		var ret string
		return ret
	}
	return *o.DepositMemo
}

// GetDepositMemoOk returns a tuple with the DepositMemo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Quote) GetDepositMemoOk() (*string, bool) {
	if o == nil || IsNil(o.DepositMemo) {
		return nil, false
	}
	return o.DepositMemo, true
}
...
// SetDepositMemo gets a reference to the given string and assigns it to the DepositMemo field.
...
func (o Quote) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DepositMemo) {
		toSerialize["depositMemo"] = o.DepositMemo
	}
